...
class MangaDexClient:
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": "MangaKoro/1.0 (desktop reader)"})
    ...
    def search(self, title: str = "", **filters: Any) -> list[dict[str, Any]]:
    ...
    def manga(self, manga_id: str) -> dict[str, Any]:
        item = self._get(f"/manga/{manga_id}", [("includes[]", "cover_art")]).get("data", {})
